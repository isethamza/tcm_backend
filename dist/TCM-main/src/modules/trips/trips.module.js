...
const public_trips_controller_1 = require("./public-trips.controller");
let TripsModule = class TripsModule {
};
exports.TripsModule = TripsModule;
exports.TripsModule = TripsModule = __decorate([
    (0, common_1.Module)({
        imports: [prisma_module_1.PrismaModule, kyc_module_1.KycModule],
        controllers: [trips_controller_1.TripsController, public_trips_controller_1.PublicTripsController],
