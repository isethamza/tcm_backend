...
let VerificationController = class VerificationController {
    pickupVerification(req, dto) {
        return {
            verifier: req.user.userId,
            status: 'VERIFIED'
        };
    }
    deliveryVerification(req, dto) {
        return {
            verifier: req.user.userId,
            status: 'DELIVERED'
        };
...
], VerificationController.prototype, "pickupVerification", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", void 0)
], VerificationController.prototype, "deliveryVerification", null);
